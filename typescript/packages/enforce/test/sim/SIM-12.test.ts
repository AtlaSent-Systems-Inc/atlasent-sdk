...
const fx = loadFixture("SIM-12");

describe(fx.title, () => {
  it("denies with permit_not_found when verifyPermit returns 404", async () => {
    ...
    expect((result as { reasonCode: string }).reasonCode).toBe("permit_not_found");
