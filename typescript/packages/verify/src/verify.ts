/**
 * Offline verification for AtlaSent audit export bundles.
 *
 ...
 * ```
 *
 * Node 20+ ships Ed25519 in `crypto.webcrypto.subtle`, so this package
 * has no runtime dependencies — `npx @atlasent/verify ./bundle.json`
 * works on a fresh box without any other install.
 */
