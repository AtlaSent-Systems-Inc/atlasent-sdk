...
| B.SDK11 | Publish — npm `@atlasent/sdk@2.x` + `@atlasent/behavior@1.0.0`; publish held per governance until runtime stabilization + deployment topology reconciliation complete | partial — `@atlasent/sdk@2.5.0` **published** to npm (`latest` tag); the 2.x publish gate has cleared (umbrella `atlasent/ROADMAP.md`: DONE 2026-05-17, atlasent-sdk#239). `@atlasent/behavior@1.0.0` **not yet published** (404 on npm). |
